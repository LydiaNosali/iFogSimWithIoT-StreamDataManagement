...
public class FogEvents {
	...
	public static final int ADD_STREAM_TO_CACHE = BASE + 44;
	
	public static final int STREAM_INITIAL_STORAGE = BASE + 45;
	
	public static final int CREATE_RETRIEVE_STREAM_DATA = BASE + 46;
	public static final int RETRIEVE_STREAM_DATA = BASE + 47;
	public static final int SEND_STREAM_TO_CONSUMER = BASE + 48;
	public static final int STREAM_PROCESS = BASE + 49;
